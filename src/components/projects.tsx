...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "scrapes u.s. patent office website to create a full company patent citation ranking. currently in use at the Rice University office of the general counsel.",
    links: {
  ...
  },
  {
    ...
    description: "scrapes student & faculty directory, uses insightface for face recognition. software donated to st. john's school yearbook.",
    links: {
